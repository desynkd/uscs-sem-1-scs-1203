<?php
    ...
    require_once 'includes/view/show_tables_view.inc.php';
    if (isset($_GET['action']) && $_GET['action'] === "load")
    {
        include 'includes/show_tables.inc.php?action=load';
    }
?>
...
<div class='bold-line'></div>
    ...
    <div class='window-large'>
        ...
        <div class='content'>
            <div class="welcome">Display Tables</div>            

            <form action="includes/show_tables.inc.php?update=true" method="post">
