...
function registerInput()
{
    ...
    if (isset($_SESSION["register_data"]["regno"]) && !isset($_SESSION["errors_register"]["regno_invalid"])) {
        echo '<input type="text" name="regno" placeholder="RA Registeration Number" value="' . $_SESSION["register_data"]["regno"]  .'" class="input-line full-width"></input>';
    }
    else{
        echo '<input type="text" name="regno" placeholder="RA Registration Number" class="input-line full-width"></input>';
    }
}
